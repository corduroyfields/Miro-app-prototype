...
A clickable web prototype of a **personalized "best places to live" recommender**, built directly from the [**Web App MVP** Miro board](
(https://miro.com/app/board/uXjVHLZLYTA=/?share_link_id=375595503240)) using Claude Code and the Miro MCP server. The board's three diagrams -  a UX flow, a database ERD, and a three-layer recommendation engine flowchart, are the source of truth for everything in this repo.
